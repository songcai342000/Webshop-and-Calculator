<%@ Page Title="Skin Care Products" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Sproducts.aspx.cs" Inherits="Sproducts" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID = "MainContent" runat="server">
 <style type="text/css">
    ...
    <br>
        <h5><a href="Pproducts.aspx">Perfume</a>&nbsp; &nbsp; &nbsp; &nbsp; <a href="Cproducts.aspx">Cosmetic</a>&nbsp; &nbsp; &nbsp; &nbsp;<a href="Hproducts.aspx">Hair Care</a></h5> 
    <h2><%: Title%></h2> 
<div class="row">
