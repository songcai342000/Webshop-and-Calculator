<%@ Page Title="Hair Care Products" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Hproducts.aspx.cs" Inherits="Hproducts" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID = "MainContent" runat="server">
 <style type="text/css">
     td{width:175px;padding-left:3px;padding-right:5px;}
</style>    <br>
    <h5><a href="Sproducts.aspx">Skin Care</a>&nbsp; &nbsp; &nbsp; &nbsp; <a href="Pproducts.aspx">Perfume</a>&nbsp; &nbsp; &nbsp; &nbsp;<a href="Cproducts.aspx">Cosmetic</a></h5> 
    <h2><%: Title%></h2> 
<div class="row">
